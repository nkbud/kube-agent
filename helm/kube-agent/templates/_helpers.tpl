...
helm.sh/chart: {{ include "kube-agent.chart" . }}
{{ include "kube-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "kube-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
